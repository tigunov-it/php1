...
<!--    </div>-->
    ...
    <div class="gallery">
        ...
        <?php foreach ($smallPhoto as $fotoname): ?>
            <a rel="gallery" class="photo" href="gallery_img/big/<?=$fotoname?>"><img src="gallery_img/small/<?=$fotoname?>" width="150" height="100" /></a>
        <?php endforeach; ?>
...
<div id="main">
    ...
    <div class="gallery">
        ...
        <?php foreach ($smallPhoto as $fotoname): ?>
            <a class="photo2" href="gallery_img/big/<?=$fotoname?>" target=_blank><img src="gallery_img/small/<?=$fotoname?>" width="150" height="100" /></a>
        <?php endforeach; ?>
